...
# following background. You should be as detailed as possible
    ...
    prompt_template = "{prefix}{question}{midfix}"
    target_template = "The question is related to: {context} Answer: {answer}"
    def tokenize_function(examples):
        ...
        prompt_ = prompt_template.format(prefix=examples['prefix'],question=examples['question'],midfix=examples["midfix"])
        target = target_template.format(context=examples['context'], answer=examples['answer'])
